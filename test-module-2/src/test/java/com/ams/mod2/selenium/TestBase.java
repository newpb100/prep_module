...
public class TestBase {
    ...
    protected void openSettings(String field_name_rus) throws InterruptedException {
        int treeIndex = 0;
        // open settings
    ...
    protected void openProject(String monthAndYearRus) {
    ...
    protected void login(SpektrUser spektrUser) {
