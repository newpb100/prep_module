...
public class ViewBorderParamsTest {
    ...
    private void openSettings(String field_name_rus) throws InterruptedException {
        int treeIndex = 0;
        // open settings
    ...
    private void openProject(String monthAndYearRus) {
    ...
    private void login() {
        ...
        driver.findElement(By.id("password")).sendKeys("cgtrnhp,c2022");
